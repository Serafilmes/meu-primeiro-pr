...
7 · Marca e identidade visual               ████████░░░░  INICIADA (s58 — TODAS as telas operacionais full-dark)
        ...
        └─ ✅ TODAS as telas operacionais agora no escuro (com o Kanban da s55)
        └─ falta da pele: a página Match/Operação (aba "Match", única ainda clara — mistura o monitor da 2ª máquina)
           · ícone do app real · grid · lockup em contornos
