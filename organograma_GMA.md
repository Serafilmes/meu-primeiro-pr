...
7 · Marca e identidade visual               ████░░░░░░░░  INICIADA (s54 — glifo + animação salvos)
        ...
        └─ SALVO EM ARQUIVO ✅ (s54): marca/6floor_simbolo.svg · _trabalhando.svg · _lockup.svg
           + doc desenho_camada7_marca_GMA.md (fonte de verdade da C7; rascunhos não evaporam mais)
        └─ falta: ícone do app real · paleta completa · grid · aplicar nas telas · lockup em contornos
